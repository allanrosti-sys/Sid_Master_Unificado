...
{
    public class Table_tblControllerTypes : Table
    {
        public Table_tblControllerTypes()
        {
            tableName = "tblControllerTypes";
            name = "Tipo de Controladores";

            tblControllerTypes model = new tblControllerTypes();
        ...
        {
            tblControllerTypes returnedObject = Function.MapToClass<tblControllerTypes>(dataTable);
            return returnedObject;
        }

        public override int Update(object input)
        {
            tblControllerTypes model = (tblControllerTypes)input;
            string sqlString = Function.Update_String<tblControllerTypes>(model, tableName, $"{field01} = {model.iID}");
        ...
        public override int Insert(object input)
        {
            ...
            string sqlString = Function.Insert_String<tblControllerTypes>((tblControllerTypes)input, tableName);
        ...
        public override object DuplicateModel(int id)
        {
            ...
            tblControllerTypes model = (tblControllerTypes)MapModel(dt);
            model.iID = Convert.ToInt32(complex.Connection.SelectScalar(Function.SqlLastID(tableName, field01, ""))) + 1;
            //model.iIndexNo = Convert.ToInt32(complex.Connection.SelectScalar(Function.SqlLastID(tableName, field04, $"{field05}={model.iControllerID}"))) + 1;
            return model;
        }
