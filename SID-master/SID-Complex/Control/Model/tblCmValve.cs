...
namespace SID.Complex.Control.Model
{
    public class tblCmValve
    {
        ...
        [Mapping(ColumnName = "iTypeID", Type = MappingType.ForeignKey, ForeignTable = ForeignTable.ValveType)]
        ...
        [Mapping(ColumnName = "bNormallyOpen", Type = MappingType.Boolean)]
        ...
        [Mapping(ColumnName = "sDeviceAdrInputInAct", Type = MappingType.Text)]
        public string sDeviceAdrInputInAct { get; set; }

        [Mapping(ColumnName = "sDeviceAdrInputAct", Type = MappingType.Text)]
        public string sDeviceAdrInputAct { get; set; }

        [Mapping(ColumnName = "sDeviceAdrOutputFine", Type = MappingType.Text)]
        public string sDeviceAdrOutputFine { get; set; }

        [Mapping(ColumnName = "iTravelTime", Type = MappingType.Integer)]
        public int iTravelTime { get; set; }
        ...
        [Mapping(ColumnName = "iErrorDelayCheck", Type = MappingType.Integer)]
        public int iErrorDelayCheck { get; set; }
