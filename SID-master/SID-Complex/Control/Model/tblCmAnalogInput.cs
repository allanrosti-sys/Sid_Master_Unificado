...
namespace SID.Complex.Control.Model
{
    public class tblCmAnalogInput
    {
        ...
        [Mapping(ColumnName = "iTypeID", Type = MappingType.ForeignKey, ForeignTable = ForeignTable.AnalogInputType)]
        ...
        [Mapping(ColumnName = "bBrokenWireAlarm", Type = MappingType.Boolean)]
        public bool bBrokenWireAlarm { get; set; }

        [Mapping(ColumnName = "bTransmitterRangeAlarm", Type = MappingType.Boolean)]
        public bool bTransmitterRangeAlarm { get; set; }

        [Mapping(ColumnName = "bExternalRescale", Type = MappingType.Boolean)]
        public bool bExternalRescale { get; set; }

        [Mapping(ColumnName = "bTranRangDevLatch", Type = MappingType.Boolean)]
        public bool bTranRangDevLatch { get; set; }
