...
{
    [XmlRoot(ElementName = "FTAlarmElement", Namespace = "urn://www.factorytalk.net/schema/2003/FTLDDAlarms.xsd")]
    public class FTAlarmElement
    {

        [XmlElement(ElementName = "DiscreteElement", Namespace = "urn://www.factorytalk.net/schema/2003/FTLDDAlarms.xsd")]
